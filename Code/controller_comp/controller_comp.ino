...
int brakeServoOutput3;                      // servo output for brake
...
int brakeServoOutputProcessed3;             // after processed for locking
...
AnalogSmoothInt smoothedBrake3 = AnalogSmoothInt(5);
...
void setup() {
  ...
  brakeServo3.attach(brakePWMPin3,minHighTime,maxHighTime);
